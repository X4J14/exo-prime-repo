...
;; https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/mandelbrot-sbcl-3.html
;;
  ...
  (let ((n (or in-n
             (ignore-errors
               (parse-integer (car (last #+sbcl sb-ext:*posix-argv*
                                         ...
                                         #+gcl  si::*command-args*)))))))
    (with-open-stream (stream (sb-sys:make-fd-stream (sb-sys:fd-stream-fd *standard-output*)
