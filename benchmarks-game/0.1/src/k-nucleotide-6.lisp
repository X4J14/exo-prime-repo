...
;; https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/knucleotide-sbcl-6.html
;;
...
(defconstant NUCLEOTIDE-FRAGMENTS #("GGT" "GGTA" "GGTATT" "GGTATTTTAATT" "GGTATTTTAATTTATAGT"))
...
(defun main (&optional (pifile #p"/dev/stdin"))
  (let* ((msequenceraw (read-in-data-chunked pifile))
