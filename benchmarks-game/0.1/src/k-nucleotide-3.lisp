...
;; https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/knucleotide-sbcl-3.html
;;
...
(defun main (&optional (filename #p"/dev/stdin"))
  (declare (optimize (speed 0) (safety 1)))
  (with-open-stream (*standard-input* (open filename :element-type 'base-char))
